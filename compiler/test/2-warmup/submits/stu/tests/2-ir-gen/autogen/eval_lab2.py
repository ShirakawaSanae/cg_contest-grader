...
for level in suite:
    ...
    for case in cases:
        casename = path.join(
            "/coursegrader/testdata/testcases/", lv_name, case) + ".cminus"
        ansname = path.join("/coursegrader/testdata/answers/", lv_name, case)
...
if __name__ == "__main__":
    # eval()
    with open("./caseconfig.json", "w") as f:
        f.write(json.dumps(caseconfig, indent=2))
