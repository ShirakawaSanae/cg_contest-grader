...
track_depend_env_key = [track_auth_jwt_env_key, track_root_statement_env_key,
                        track_root_activity_env_key, track_grading_enable_config_key,
                        track_lrs_endpoint_config_key, track_auth_jwt_secret_config_key,
                        track_auth_jwt_config_key, track_debug_config_key, track_http_enable_config_key,
                        track_file_back_up_dir_config_key]
